...
const Login = (props) => {
    return (
        <div className="login-container">
            <h1 className="font-semibold text-2xl p-2 mb-4">Welcome To <span className="text-white">Decentralized Voting BlockChain Application </span> DAPP ❤️</h1>
      ...
      <ul className="my-4 space-y-3">
        <li onClick = {props.connectWallet}>
